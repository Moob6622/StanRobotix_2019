...
// */
// void DetectLines::Process(cv::Mat& source0){
// 	//Step Find_Lines0:
// 	//input
...
// 	double filterLinesMinLength = 200.0;  // default Double
...
//  */
// std::vector<Line>* DetectLines::GetFindLinesOutput(){
...
//  */
// std::vector<Line>* DetectLines::GetFilterLinesOutput(){
...
// 	 */
// 	void DetectLines::findLines(cv::Mat &input, std::vector<Line> &lineList) {
...
// 	 */
// 	void DetectLines::filterLines(std::vector<Line> &inputs, double minLength, double angle[], std::vector<Line> &outputs) {
// 	outputs.clear();
